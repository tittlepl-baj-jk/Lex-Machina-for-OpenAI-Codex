...
### Zakres
Prawo bankowe (czynności bankowe, tajemnica bankowa, kredyty, gwarancje), nadzór KNF (licencje, sankcje, lista ostrzeżeń), BFG (gwarancja depozytów do 100 000 EUR, resolution), gry hazardowe (KAS jako organ nadzoru).
...
## 2. PRAWO BANKOWE — ZASADY ABSOLUTNE

```
Czynności bankowe zastrzeżone (art. 5 PrBank):
  → Tylko bank może przyjmować depozyty / udzielać kredytów bankowych
  → Naruszenie → odpowiedzialność karna (art. 171 PrBank)

Tajemnica bankowa (art. 104 PrBank):
  → Ujawnienie tylko na podstawie przepisów ustawy (US, prokurator, sąd, KNF, ABW, UIF)
  → Ujawnienie bez podstawy = przestępstwo

Fundusz Gwarancyjny BFG:
  → Gwarancja do 100 000 EUR na jedną osobę / jeden bank
  → Małżonkowie: każdy osobno do 100 000 EUR
  → Termin wypłaty: 7 dni roboczych
  → Specjalne: do 200 000 EUR przez 3 miesiące (sprzedaż nieruchomości, odprawa)
  → ⚠️ Weryfikuj aktualne kwoty w ustawie o BFG
```

---

## 3. NOWELIZACJE PRAWA BANKOWEGO 2025

```
Dz.U. 2025 poz. 1170 i poz. 1191 (ustawa z 25.07.2025) — OBOWIĄZUJĄ:
  → Obowiązek zgody KNF na powołanie członków zarządu dużych banków
...
## 4. NADZÓR KNF — ZAKRES I UPRAWNIENIA

```
Nadzoruje:
  Banki i SKOK-i
  Zakłady ubezpieczeń i reasekuracji
  Fundusze inwestycyjne i emerytalne (OFE, PPK, PPE)
  Domy maklerskie i GPW
  Instytucje płatnicze
  Dostawcy kryptoaktywów (CASP — po wdrożeniu MiCA)

Uprawnienia KNF:
  □ Wydawanie zezwoleń na działalność regulowaną
  □ Kontrole na miejscu i zdalnie
  □ Cofnięcie zezwolenia, kara pieniężna, zakaz działalności
  □ Publikacja listy ostrzeżeń (podmioty bez licencji / fraud)
  □ Zgoda na powołanie zarządu dużych banków (od 2025 r.)

Rejestr i lista ostrzeżeń: https://knf.gov.pl
```

---

## 5. RESOLUTION — PRZYMUSOWA RESTRUKTURYZACJA (BFG)

```
Przesłanki resolution:
  □ Bank grozi upadłością + brak środków prywatnych + interes publiczny

Narzędzia:
  1. Sprzedaż przedsiębiorstwa bankowego (tzw. bank bridge)
  2. Instytucja pomostowa
  3. Wydzielenie aktywów (bad bank)
  4. Umorzenie lub konwersja zobowiązań (bail-in) → akcjonariusze i wierzyciele ponoszą koszty

Organ resolution: BFG
```

---

## 6. GWARANCJA DEPOZYTÓW — TABELA

| Rodzaj | Kwota gwarancji | Termin wypłaty |
|---|---|---|
| Standardowy depozyt | do 100 000 EUR | 7 dni roboczych |
...
**Output:** Kwalifikacja (czynność bankowa / nadzór KNF / depozyt) → prawa i obowiązki → środki ochrony → rekomendacja.

**Powiązania:** `mod-ustawa-AML-instytucje-obowiazkowe` | `mod-ustawa-rynek-kapitalowy-fundusze` | `dr-11` (cyberbezpieczeństwo w sektorze bankowym) | `pisma-procesowe-v3`

**Źródła:** https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20260000038 | https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20250000640 | https://knf.gov.pl | https://www.bfg.pl
...
Zasady absolutne:
  □ Monopol państwowy: Totalizator Sportowy (lotto, loterie pieniężne)
  □ Zakaz reklamy hazardu poza dozwolonymi wyjątkami (weryfikuj w ustawie)
  □ Wiek: 18 lat — zakaz uczestnictwa osób niepełnoletnich (art. 15 ust. 1)
  □ Rejestr domen hazardowych KAS: blokada stron bez zezwolenia

Zezwolenia:
  → Minister Finansów: kasyna gry, salony gier, zakłady wzajemne
  → Urząd Celno-Skarbowy: rejestracja automatów poza kasynem → ZAKAZ od 2016

Sankcje:
  → Udział w nielegalnym hazardzie: grzywna do 240 stawek dziennych (KKS)
  → Przepadek wygranych z nielegalnego hazardu

Weryfikacja legalności podmiotu:
  web_search: "KAS rejestr domen hazardowych blokada 2025 2026"
  https://www.podatki.gov.pl (wyszukaj legalne podmioty)
```
