# Akcyza — część 2: olej opałowy vs napędowy, automaty do papierosów, opłata paliwowa/emisyjna
...
⭐⭐ REFORMA — ZAMKNIĘCIE LUKI OD 1.01.2015 R. (DWA jednoczesne
  ...
  2) LEGALNE wytwarzanie PRZY UŻYCIU maszyn TYLKO w punktach
     ...
     "WYROBY NIKOTYNOWE" w pliku `part-01-weglowe-nikotynowe.md`) —
     SPÓJNY, POWTARZALNY wzorzec legislacyjny w tej
     dziedzinie prawa
