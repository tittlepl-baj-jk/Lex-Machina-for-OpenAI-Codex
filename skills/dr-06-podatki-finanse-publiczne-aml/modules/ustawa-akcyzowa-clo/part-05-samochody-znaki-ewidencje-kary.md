# Akcyza — część 5: audyt pokrycia — samochody osobowe, znaki akcyzy, ewidencje, kary pieniężne
...
KARA ZA IMPORT PRZY WYGAŚNIĘTYM DŁUGU CELNYM (art. 138w): GDY
  ...
  modułu "TAKSONOMIA TECHNIK obchodzenia AKCYZY" w pliku
  `part-03-taksonomia-zakres.md`)
