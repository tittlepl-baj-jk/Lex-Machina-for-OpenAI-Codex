# Akcyza — część 3: taksonomia technik obchodzenia akcyzy, zakres podatku akcyzowego
...
prawnym):
  ...
  6) ⭐ NIELEGALNA PRODUKCJA POZA SKŁADEM PODATKOWYM — DOTYCZY
     ...
     automatach w pliku `part-02-olej-automaty-oplata.md`;
     spirytus etylowy; NAWET paliwa mieszane) —
