...
Pogłębione zagadnienia (reklama produktów leczniczych, odpowiedzialność karna,
nadzór GIF/URPL, procedury rejestracyjne) — patrz sekcje CZĘŚĆ I–VIII powyżej
oraz `mod-wyroby-medyczne.md` (CZĘŚĆ IX — wydzielona 2026-06-12). Terminy i
roszczenia procesowe → `shared/TERM-CALC.md`, `shared/ROSZCZENIA.md`.
...
REGUŁA: Do obrotu dopuszczone są produkty lecznicze, które uzyskały:
  → pozwolenie krajowe (wydaje Prezes URPL)
  → pozwolenie unijne (Rada UE lub Komisja Europejska — EMA)

PREZES URZĘDU = Prezes Urzędu Rejestracji Produktów Leczniczych, Wyrobów
                Medycznych i Produktów Biobójczych (URPL) ✅ VER online 2026-06-14
                (gov.pl/web/urpl) — "UPLWMiPB" to błędny wariant nazwy, NIE używać
...
| URPL (Urząd Rejestracji Produktów Leczniczych, Wyrobów Medycznych i Produktów Biobójczych) | urpl.gov.pl / gov.pl/web/urpl | Rejestr pozwoleń, decyzje, wytyczne |
