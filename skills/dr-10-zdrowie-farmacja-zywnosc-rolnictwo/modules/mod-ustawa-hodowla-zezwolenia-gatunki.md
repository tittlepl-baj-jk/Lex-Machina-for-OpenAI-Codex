...
## Połącz z
- DR-10/mod-ustawa-bezpieczenstwo-zywnosci (moduł MACIERZYSTY)
- DR-10/mod-ustawa-hodowla-zdrowie-zwierzat (hodowla zachowawcza, ASF,
  szczepienia, KROPiK)
- DR-02/mod-KC-cywilne-zobowiazania-odpowiedzialnosc (odpowiedzialność
  za zwierzęta — ogólne zasady KC)

## Weryfikacja online
```
web_search: "zezwolenie na hodowlę gatunki zwierząt Polska ustawa ochrona przyrody"
web_search: "gatunki inwazyjne lista Polska rozporządzenie 2026"
```
