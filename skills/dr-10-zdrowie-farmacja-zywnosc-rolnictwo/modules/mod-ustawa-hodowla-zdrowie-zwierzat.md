...
(dodano 2026-07-30, na żądanie użytkownika; SCALONO 2026-08-12 z
dwóch komplementarnych sekcji dodanych tego samego dnia — usunięto
duplikację przy zachowaniu wszystkich unikalnych elementów obu)
...
PODSTAWA PRAWNA: ustawa z 21.11.2025 o zdrowiu zwierząt + rozp.
  MRiRW z 12.03.2026 ws. środków zwalczania ASF (oba akty zastąpiły
  starsze przepisy)
...
(A) STREFY LOKALNE WOKÓŁ KONKRETNEGO OGNISKA (krajowe, tymczasowe,
  ...
  □ Obszar ZAGROŻONY — sięgający MIN. 7 KM POZA obszar zapowietrzony
    (czyli łącznie min. ~10 km promienia od ogniska) — ⚠️ niektóre
    rozporządzenia wojewódzkie WYZNACZAJĄ szerzej (np. 10 km
    bezpośrednio, jak w przykładzie kujawsko-pomorskim z lipca 2026)
  → CZAS TRWANIA ograniczeń: powiatowy lekarz weterynarii MOŻE GO
    SKRÓCIĆ do: **30 DNI** (zapowietrzony) / **20 DNI** (zagrożony)
...
(B) STREFY UNIJNE — REGIONALIZACJA DŁUGOTERMINOWA (Rozp. Wykonawcze
    Komisji Europejskiej, aktualizowane regularnie):
  □ Obszar I (kolor NIEBIESKI) — teren WOLNY od ASF, ale GRANICZĄCY z
    obszarem, gdzie chorobę wykryto (u dzików LUB świń)
  □ Obszar II (kolor RÓŻOWY) — chorobę potwierdzono u DZIKÓW
  □ Obszar III (kolor CZERWONY) — NAJWYŻSZY poziom restrykcji, wokół
    OGNISK u ŚWIŃ HODOWLANYCH (nie tylko dzików)
...
⚡ PRZYKŁAD SKALI ZMIENNOŚCI W SAMYM 2026 R. (potwierdzony w 8+
  ...
  → 16 LIPCA 2026 (Rozp. Wykonawcze KE 2026/1795): PONOWNE
    rozszerzenie obszaru III (czerwonego) o części powiatów
    myśliborskiego, choszczeńskiego (zachodniopomorskie) oraz
    grudziądzkiego, chełmińskiego, świeckiego (kujawsko-pomorskie)
  → WNIOSEK: sytuacja "zero czerwonych stref" z 28 stycznia trwała
    NIECAŁE PÓŁ ROKU — obszary III ZNÓW ISTNIEJĄ na dzień weryfikacji

⭐ OFICJALNY, AUTORYTATYWNY SERWIS DO WERYFIKACJI AKTUALNEJ STREFY:
  → GIW — strona główna ASF:
    https://www.wetgiw.gov.pl/nadzor-weterynaryjny/asf-w-polsce
  → BEZPOŚREDNIA MAPA interaktywna (BIP GIW):
    https://bip.wetgiw.gov.pl/asf/mapa/
  → REGIONALIZACJA UE: kolejne rozporządzenia wykonawcze KE — NUMER
    zmienia się z każdą aktualizacją (np. 2026/1136, 2026/1795 — TO
    NIE SĄ "ostateczne" numery, będą KOLEJNE)

WYMOGI DLA HODOWCÓW W ZALEŻNOŚCI OD STREFY:
  □ Gospodarstwo w obszarze zapowietrzonym/zagrożonym: BEZWZGLĘDNY
    ZAKAZ wyprowadzania świń przez czas trwania obszaru; PO tym
    okresie — konieczność ZGŁOSZENIA do powiatowego lekarza
    weterynarii CHĘCI uzyskania POZWOLENIA na przemieszczenie
  □ Przemieszczanie świń — DODATKOWA dokumentacja, kontrola
    Inspekcji Weterynaryjnej PRZY KAŻDYM transporcie (szczególnie
    w strefie III)
  □ Karmienie zielonką/ziarnem z zagrożonych stref — WYMAGANA obróbka
    termiczna LUB składowanie niedostępne dla dzików przez **30 DNI**
  □ Słoma z obszarów II/III jako ściółka — musi "leżakować" przez
    **90 DNI** przed użyciem, chyba że poddana obróbce
    unieszkodliwiającej wirus
  □ Ubój GOSPODARCZY w strefach I/II/III — DOZWOLONY, POD WARUNKIEM
    że świnia była utrzymywana w TYM gospodarstwie min. **30 DNI**
    + badanie przed-/poubojowe
  □ ⚠️ ZNAJDOWANIE SIĘ W STREFIE III NIE OZNACZA AUTOMATYCZNEGO ZAKAZU
    ...
    Weterynaryjnej — częste błędne przekonanie warte skorygowania;
    ograniczenia dotyczą TAKŻE mięsa wieprzowego i produktów od
    świń ORAZ dzików, nie tylko żywych zwierząt

⭐ ODSZKODOWANIA: hodowcy, u których wystąpiło ognisko ASF,
  SPEŁNIAJĄCY wymagania weterynaryjne (W TYM identyfikacji i
  rejestracji świń — ⚠️ WARUNEK KONIECZNY, brak prawidłowej
  rejestracji MOŻE wykluczyć odszkodowanie) otrzymują odszkodowanie
  za: świnie zabite z nakazu Inspekcji, ZNISZCZONE PASZE, oraz SPRZĘT

⭐ OBOWIĄZEK ZGŁOSZENIA: KAŻDY hodowca, u którego wystąpiły
  niepokojące objawy chorobowe LUB PADNIĘCIA świń, MUSI zgłosić to
  BEZPOŚREDNIO powiatowemu lekarzowi weterynarii, ZA POŚREDNICTWEM
  opiekującego się gospodarstwem lekarza weterynarii, LUB ZA
  pośrednictwem właściwego organu samorządu terytorialnego (wójt/
  burmistrz/prezydent)
...
użytkownika; SCALONO 2026-08-12 z dwóch komplementarnych sekcji
dodanych tego samego dnia — usunięto duplikację przy zachowaniu
wszystkich unikalnych elementów obu)
...
⭐ DWIE ISTOTNE NOWOŚCI wprowadzone przez ustawę z 2025 r. (NIE
  ...
  1) OBOWIĄZKOWE CZIPOWANIE PRZED szczepieniem — szczepienie MUSI być
     ...
     odczytem/weryfikacją już istniejącego czipa/tatuażu — LEKARZ
     weterynarii NIE MOŻE zaszczepić psa bez wcześniejszego
     wszczepienia mikroczipa
  2) OBOWIĄZKOWA REJESTRACJA hodowli psów/kotów RASOWYCH w
     Powiatowym Inspektoracie Weterynarii (PIW) — NOWY wymóg
     administracyjny, wprowadzony W ODPOWIEDZI na głośne przypadki
     nieprawidłowości w hodowlach (szeroko relacjonowane w mediach
     na początku 2026 r.)
...
⭐ DZIKIE LISY — SZCZEPIENIA DOUSTNE (ODRĘBNY mechanizm): Polska jest
  ...
  rozp. MRiRW z 11.03.2026 r.)

⚠️ SPÓR NAUKOWO-PRAWNY W TOKU: fundacja zajmująca się ochroną
  zwierząt (Vet-Alert) SKIEROWAŁA sprawę do RZECZNIKA PRAW
  OBYWATELSKICH, wskazując, że WYMÓG corocznego szczepienia (BEZ
  ZMIAN od 1949 r.) NIE ODZWIERCIEDLA aktualnej wiedzy naukowej —
  nowoczesne szczepionki mają CHRONIĆ nawet 3 LATA. MRiRW
  ...
  rocznego. SPRAWA NIEROZSTRZYGNIĘTA na dzień tej weryfikacji.

⭐ OBOWIĄZKI DOKUMENTACYJNE I SANKCJE (DWA różne adresaci):
  → POSIADACZ psa — KARA za BRAK szczepienia: grzywna (podstawa:
    art. 102 ust. 1 pkt 1 nowej ustawy)
  → LEKARZ weterynarii — NOWY obowiązek RAPORTOWANIA do powiatowego
    lekarza weterynarii: do 3. DNIA miesiąca (liczba zaszczepionych
    psów W poprzednim miesiącu) + do 15. DNIA miesiąca (szczegółowy
    wykaz) — KARA administracyjna za niedopełnienie (brak
    zaświadczenia, brak wykazu, brak terminowego przekazania danych):
    **0,1-2× przeciętnego wynagrodzenia MIESIĘCZNEGO** (zmienna
    kwota, ogłaszana PRZEZ Prezesa GUS w Monitorze Polskim)

Potwierdzone w 7+ zgodnych, bardzo aktualnych źródłach (styczeń-lipiec
2026 r.), w tym BEZPOŚREDNIO gov.pl/wetgiw (Rząd 1) i izby lekarsko-
weterynaryjne.
```
...
- DR-10/mod-ustawa-hodowla-zezwolenia-gatunki (pseudohodowla, zezwolenia
  na gatunki, gatunki inwazyjne, odpowiedzialność za ucieczkę zwierząt)
- DR-10/mod-ustawa-inspekcja-weterynaryjna
- DR-10/mod-ustawa-lekarz-weterynarii-zawod

## Weryfikacja online
```
web_search: "ustawa o zdrowiu zwierząt Dz.U. 2025 poz. 1795 isap"
web_search: "strefy ASF Polska aktualna mapa wetgiw.gov.pl"
```
