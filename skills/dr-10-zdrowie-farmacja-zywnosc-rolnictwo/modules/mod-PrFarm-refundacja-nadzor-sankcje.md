# mod-PrFarm-refundacja-nadzor-sankcje

**Status:** moduł uzupełniający do `mod-PrFarm-szczegolowy.md`
...
Moduł główny (`mod-PrFarm-szczegolowy.md`) pokrywa: dopuszczanie produktów
leczniczych, wytwarzanie/GMP, reklamę, apteki, hurtownie.
...
> Cofnięcie zezwolenia na prowadzenie apteki (art. 103 PF) — przesłanki:
> `mod-PrFarm-szczegolowy.md` CZĘŚĆ IV.

---

## 3. SANKCJE KARNE I KARY PIENIĘŻNE
...
|---|---|
| Dopuszczanie / wytwarzanie / reklama / apteki / hurtownie | `mod-PrFarm-szczegolowy.md` |
| Wyroby medyczne (MDR/IVDR) | `mod-wyroby-medyczne.md` |
| Skarga do WSA na decyzję GIF/MZ | `dr-05` → `mod-KPA-postepowanie-administracyjne` |
| Odpowiedzialność karna — projekt pisma | `pisma-procesowe-v3` |
