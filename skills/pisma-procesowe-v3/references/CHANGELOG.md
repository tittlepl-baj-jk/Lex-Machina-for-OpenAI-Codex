...
## 5.18 (2026-08-20z4) — ujednolicenie standardu: historia zmian wyłącznie w tym pliku

Wpisy 5.12-5.17 przeniesione z korpusu SKILL.md do tego pliku. Historia tego skilla
była rozbita na DWA miejsca: starsze wpisy (5.7-5.11) tutaj, nowsze w SKILL.md —
co w sesji 2026-08-20z3 spowodowało fałszywy raport T12 o luce siedmiu wersji.
...
> ⛔ **WPISY ODTWORZONE 2026-08-20z3 (F-102, test T12).** `version` wynosił 5.17
> przy ostatnim wpisie 5.15. Odtworzone z AUDIT-JOURNAL (sekcje Rejestracja).

> **5.17 (2026-07-27w, propagacja):** limit opłaty 200 000 → 100 000 zł,
> znaleziony w 6 plikach naraz; w tym skillu poprawiony `modules/MOD-OPLATY.md`
> (t.j. Dz.U.2025.1228). Ta sama transza objęła `pisma-proste-v2` (v2.6→2.7),
> `analiza-sadowa-v6` (v6.2→6.3) i `dr-06` (v3.4→3.5). Źródło: AUDYT-2026-07-27w.

> **5.16 (2026-07-26, pełny audyt systemu w TRYBIE AUTO):** podbicie w ramach
> zbiorczej sesji obejmującej 11 skilli (dr-03, dr-08, dr-10, dr-11, dr-15,
> prawo-polskie-v2, przesluchanie-swiadkow, dr-12, ten skill, shared,
> audyt-systemu-v4). ⚠️ Dziennik nie wyszczególnia, co konkretnie zmieniono
> w TYM pliku — odnotowane uczciwie jako niepełne. Źródło: AUDYT-2026-07-26.
