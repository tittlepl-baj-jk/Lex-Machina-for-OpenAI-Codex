# mod-N-karne — adapter do kanonika

## Status
Ten plik jest adapterem. Prawo karne ogólne (KK, KPK) zostało
scentralizowane w DR-03, który jest właściwym domem dla spraw karnych.
...
- Kodeks karny (KK) — Dz.U. 2025 poz. 383 ze zm.
- Kodeks postępowania karnego (KPK) — Dz.U. 2026 poz. 490 ze zm.
...
## Źródła
- ISAP/ELI dla prawa centralnego.
- EUR-Lex dla prawa UE.

## Audyt
Jeżeli brak potwierdzenia online: `REQUIRES_SOURCE_VERIFICATION`.
