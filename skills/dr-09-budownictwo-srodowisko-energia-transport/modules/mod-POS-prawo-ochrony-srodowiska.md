...
2. **UDZIAŁ SPOŁECZEŃSTWA:** W postępowaniu OOŚ każdy może złożyć uwagi i wnioski
   (art. 29 UOOŚiS — Dz.U. 2026 poz. 670 t.j.). Organizacje ekologiczne mają prawa strony w postępowaniach
...
4. **ODPOWIEDZIALNOŚĆ KARNA (KK art. 181–188a) — Dz.U. 2025 poz. 383 t.j.:**
...
I instancja — **zależy od rodzaju instalacji** (art. 378 POŚ Dz.U. 2025 poz. 647):
...
|---|---|
| Odwołanie od DŚU / decyzji RDOŚ | `pisma-procesowe-v3` + `dr-05-prawo-administracyjne-sadowoadministracyjne/modules/mod-KPA-postepowanie-administracyjne.md` |
| Skarga do WSA (środowiskowa) | `pisma-procesowe-v3` |
| Pozwolenie na budowę po DŚU | `dr-09-budownictwo-srodowisko-energia-transport/modules/mod-PrBud-prawo-budowlane.md` |
| Odpowiedzialność karna (KK 181–188) | `dr-03-prawo-karne-wykroczenia-egzekucja/modules/mod-KK-art181-188a-przeciwko-srodowisku.md` + `dr-03-prawo-karne-wykroczenia-egzekucja/modules/mod-KK-KPK-framework-karne.md` |
...
odpowiedni moduł lokalny (lazy loading — tylko właściwy do sprawy):

```text
view dr-09-budownictwo-srodowisko-energia-transport/modules/mod-ustawa-OOS-oceny-srodowiskowe.md
view dr-09-budownictwo-srodowisko-energia-transport/modules/mod-ustawa-lesna-lowiecka-ochrona-przyrody.md
view dr-09-budownictwo-srodowisko-energia-transport/modules/mod-PrWodne-gospodarka-sciekowa.md
```
