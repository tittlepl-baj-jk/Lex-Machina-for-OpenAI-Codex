# mod-CU-odpady-gospodarka-komunalna.md — Odpady, gospodarka komunalna i odpowiedzialność środowiskowa
...
- [ ] Wersja temporalna: stan prawny na dzień zdarzenia i na dzień orzekania?
- [ ] Właściwy organ (zarząd/decyzja/kontrola) ustalony?
- [ ] Termin na odwołanie (14 dni) i na skargę do WSA (30 dni) obliczony?
- [ ] Brzmienie przepisów ze źródeł, nie z pamięci modelu?
- [ ] Ryzyka formalne i procesowe ocenione?

## OUTPUT

1. Stan faktyczny; 2. Kwalifikacja prawna; 3. Stan prawny (Dz.U. z ISAP); 4. Terminy;
5. Przesłanki; 6. Matryca dowodowa; 7. Zarzuty i kontrargumenty;
8. Strategia (ostrożny/ofensywny/eskalacyjny); 9. Ryzyka; 10. Rekomendacja.
