...
| KPC | Skarga na czynności komornika (art. 767) | Wnosi się **do komornika**, który przekazuje do sądu rejonowego (siedziba kancelarii / zasady ogólne przy wyborze) | `pisma-proste-v2/references/SPL-skarga-komornik.md`, 2026-07-25 |
...
| KPA | Odwołanie / zażalenie na decyzję/postanowienie | **Dewolutywne, ale za pośrednictwem** — do organu wyższego stopnia, ZA POŚREDNICTWEM organu, który wydał rozstrzygnięcie (art. 129 §1 / 141 §1 KPA), chyba że autokontrola (art. 132 KPA) | `pisma-procesowe-v3/modules/MOD-ADMIN.md`, 2026-07-25 |
