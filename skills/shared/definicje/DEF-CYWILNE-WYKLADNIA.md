# DEF-CYWILNE-WYKLADNIA.md
## shared/definicje/ · Prawo cywilne — wykładnia (rękojmia vs gwarancja 2023+)

> Wydzielony z DEFINICJE-KLUCZOWE.md (H.4).
> Główne zastosowanie: **DR-02** (cywilne — sprzedaż, rękojmia, gwarancja).
> Powiązane rekordy ORKA: BAS-W13 (niezgodność towaru z umową B2C od 01.01.2023).
...
### H.4 PRAWO CYWILNE — DEFINICJE I WYKŁADNIA

#### H.4.1 Rękojmia vs gwarancja — systematyka 2023+

```
RĘKOJMIA (art. 556–576 KC — dla B2B + art. 43a–43n u.p.k. — dla B2C od 2023):
  = ustawowa odpowiedzialność SPRZEDAWCY za wady fizyczne i prawne rzeczy
...
KLUCZOWA ZMIANA 2023 (implementacja dyrektywy 2019/771):
  ...
  B2B: stara rękojmia KC pozostała bez zmian
```
...
---
*DEF-CYWILNE-WYKLADNIA.md · shared/definicje/ · 2026-06-12*
*Wydzielono z DEFINICJE-KLUCZOWE.md (Blok H.4)*
