...
**⛔ NAPRAWIONO 2026-07-02 (WARN-27) — ZMIANA SYSTEMOWA OD 5.03.2026:**
Ustawa specjalna z 12.03.2022 r. (Dz.U. 2022 poz. 583, ostatni znany t.j.
2025.337) została w ISTOTNYM ZAKRESIE WYGASZONA ustawą z 23.01.2026 r.
o wygaszeniu rozwiązań wynikających z ustawy o pomocy obywatelom Ukrainy
(**Dz.U. 2026 poz. 203**, w życie 5.03.2026 r. — z wyjątkami). Poniższy
tekst zastępuje poprzednią, częściowo nieaktualną wersję ANEKSU A.

**Akty aktualne po 5.03.2026 r. (zamiast dawnej specustawy jako jedynego
źródła):**
| Zagadnienie | Akt właściwy OD 5.03.2026 | Uwaga |
|---|---|---|
...
PESEL ze statusem UKR nadany na podstawie oświadczenia:
  → wymaga potwierdzenia tożsamości ważnym dokumentem podróży w dowolnym
    urzędzie gminy do 31.08.2026 r.
  → brak potwierdzenia → od 1.09.2026 status UKR zmieniony na NUE
    (utrata uprawnień związanych z ochroną czasową)

Powiadomienia PUP o powierzeniu pracy złożone PRZED 5.03.2026 r.:
  → zachowują ważność, NIE wymagają ponownego złożenia

Obywatele Ukrainy przebywający legalnie w PL, ale NIE w związku z wojną:
  → przez 3 lata od wejścia w życie ustawy (do 4.03.2029) mogą pracować
    na zasadach analogicznych do beneficjentów ochrony czasowej
```

**⚠️ ZASTRZEŻENIE METODOLOGICZNE:** powyższe informacje pochodzą z
weryfikacji online przeprowadzonej 2026-07-02 (sesja TRYB DZU + WARN-27).
Materia jest wyjątkowo dynamiczna (kolejne nowelizacje w 2025-2026 r.) —
PRZED zastosowaniem w konkretnej sprawie należy ponownie zweryfikować
aktualny stan w ISAP, w szczególności: (1) dokładny t.j. ustawy o
udzielaniu cudzoziemcom ochrony po zmianach, (2) czy nie doszło do
kolejnych nowelizacji po 2026-07-02, (3) indywidualny status danej osoby
(daty wjazdu, rodzaj dokumentu, ewentualne wcześniejsze wnioski).

```
web_search: "ustawa o wygaszeniu rozwiązań pomoc obywatelom Ukrainy Dz.U. 2026 poz. 203 isap"
web_search: "ustawa o udzielaniu cudzoziemcom ochrony na terytorium RP tekst jednolity 2026"
```
