...
- ustawy służbowe
- KPA/PPSA w zakresie kontroli decyzji
...
- dostęp do akt
- kontrola sądowa ograniczonej jawności
...
Klauzule tajności:
  ŚCIŚLE TAJNE (ST) — najwyższa; dostęp: szef ABW/SKW
  TAJNE (T)
  POUFNE (P)
  ZASTRZEŻONE (Z) — najniższa

Postępowanie sprawdzające:
  → Wszczyna: ABW (cywilne) lub SKW (wojskowe) na wniosek kierownika jednostki
  → Zwykłe (Poufne/Zastrzeżone): prowadzi służba
  → Poszerzone (Tajne/Ściśle Tajne): rozszerzone badanie
  → Decyzja: poświadczenie bezpieczeństwa albo odmowa
...
Cofnięcie poświadczenia:
  → Skutek: utrata dostępu do stanowiska wymagającego poświadczenia
  → Możliwe podstawy: zmiany w stanie bezpieczeństwa, postępowanie karne
  → Tryb zaskarżenia: jak przy odmowie

web_search: "postępowanie sprawdzające poświadczenie bezpieczeństwa odmowa WSA orzecznictwo 2025"
```
