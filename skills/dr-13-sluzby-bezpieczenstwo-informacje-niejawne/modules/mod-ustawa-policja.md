...
- Ustawa o Policji
- akty wykonawcze MSWiA dotyczące służby, dyscyplinarki, dokumentacji i użycia środków przymusu
- ustawa o środkach przymusu bezpośredniego i broni palnej
- KPK/KW/KPA w zakresie czynności i skarg
...
Odpowiedzialność odszkodowawcza Skarbu Państwa za działania Policji:
  ...
  → Art. 15e ustawy o Policji — odszkodowanie za bezprawne zatrzymanie
  → Właściwy: sąd cywilny (nie WSA)
  → Przedawnienie: 3 lata od dowiedzenia się o szkodzie (art. 4421 KC — weryfikuj)

Skargi na funkcjonariuszy Policji:
  □ Skarga do przełożonego (art. 227 KPA + przepisy wewn.)
  □ Skarga do prokuratury (zawiadomienie o przestępstwie)
  □ Pozew cywilny o odszkodowanie (SO lub SR wg WPS)
  □ Skarga do RPO
  □ Skarga do Sejmowej Komisji ds. Służb Specjalnych (dla ABW/AW/CBA)
```
