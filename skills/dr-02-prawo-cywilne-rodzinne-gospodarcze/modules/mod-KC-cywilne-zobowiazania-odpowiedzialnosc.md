...
> ⚡ **ZMIANA STRUKTURALNA 2026-08-20 (F-78, priorytet 9):** ten plik był
> 1395 linii. Treść 22 sekcji PODZIELONA na 8 plików w podkatalogu
> `kc-zobowiazania/`. TEN plik pozostaje pod NIEZMIENIONĄ nazwą jako
> LEKKI INDEKSATOR — odsyłacze w systemie NIE WYMAGAŁY EDYCJI. CORE,
> INTAKE i PROCEDURA (stosowane ZAWSZE, niezależnie od tematu sprawy)
> POZOSTAJĄ w tym indeksie.
...
|---|---|---|
| Przedawnienie, kara umowna, wady oświadczenia woli, bezpodstawne wzbogacenie, odsetki | Sekcje 4, 5, 6, 7, 9 | `czesc-01-przedawnienie-kara-umowna-wady-wzbogacenie-odsetki.md` |
| Skarga pauliańska (art. 527-534 KC) | Sekcja 8 (⚡ rozbudowana 2026-08-20) | `czesc-02-skarga-paulianska.md` |
| Dowody, strategia, orzecznictwo, quality gate, output, predykcja, źródła | Sekcje 10-14 + predykcja + źródła | `czesc-03-dowody-strategia-referencje.md` |
| Służebności i prawo rzeczowe (KC Księga II) | Aneks D | `czesc-04-aneks-d-sluzebnosci.md` |
| Wywłaszczenie pod inwestycje publiczne | Aneks E | `czesc-05-aneks-e-wywlaszczenie.md` |
| Bezumowne korzystanie z rzeczy/nieruchomości | — | `czesc-06-bezumowne-korzystanie.md` |
| Zameldowanie i wymeldowanie | — | `czesc-07-zameldowanie-wymeldowanie.md` |
| "Dzikie mieszkanie"/samowolne zajęcie pustostanu, powiązania z innymi modułami | — | `czesc-08-dzikie-mieszkanie-powiazania.md` |
...
```
KROK 1 — Przejdź przez CORE, INTAKE i PROCEDURĘ (wyżej w tym indeksie) —
  ZAWSZE, niezależnie od tematu sprawy.
...
KROK 3 — Wczytaj WYŁĄCZNIE plik zawierający ten temat (view czesc-0X-*.md
  z podkatalogu `kc-zobowiazania/`) — NIE wczytuj wszystkich 8 naraz.
KROK 4 — Sprawdź QUALITY GATE (część 3) przed wydaniem analizy/pisma.
```

---
*mod-KC-cywilne-zobowiazania-odpowiedzialnosc.md · dr-02/modules/ · indeks utworzony 2026-08-20 (F-78, priorytet 9)*
