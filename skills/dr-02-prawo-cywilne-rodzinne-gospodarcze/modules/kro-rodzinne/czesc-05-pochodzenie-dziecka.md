# KRO — część 5: pochodzenie dziecka (macierzyństwo, ojcostwo, surogacja)
...
OBOWIĄZEK ALIMENTACYJNY SZERSZEGO KRĘGU KREWNYCH w pliku
`czesc-04-alimenty.md`), przesłanki
