# KRO — część 7: procedura, dowody, zmiana imienia i nazwiska
...
KALKULATOR KLUCZOWYCH TERMINÓW niżej w TYM pliku — ⚠️ [NAPRAWIONO
2026-08-20, F-78: oryginalne odesłanie wskazywało błędnie na "OPŁATY
SĄDOWE" — treść "powrót do nazwiska, 12 miesięcy, art. 59 KRO" faktycznie
znajduje się w sekcji KALKULATOR, nie OPŁATY SĄDOWE; błąd przedtem
istniejący, niezwiązany z podziałem — obie sekcje pozostają w tym samym
pliku part-07, więc lokalizacja pliku była zawsze poprawna]) — dotyczy
zmiany z INNYCH powodów, w KAŻDYM
życia.
